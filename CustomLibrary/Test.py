...
def create_excel(location):
       ...
       ws.write(0,1,'TEST CASE NAME',style0)
       ws.write(0,2,'RESULT',style0)
       ws.col(0).width = 6000
...
def add_result(status1,tc_no1,exp_result1):
       global ws
       global Locaitonfile
       status = status1
       tc_no = tc_no1
       ...
       wbW.get_sheet(1).col(1).width = 20000
...
def AppendBANTOFile(BANString):
    nl = "\n"    
    tf = open('D:\PT168\TELUS_Project_02\Output\CreatedBAN.txt',"a+")    
...
if __name__ == "__main__":
       createResultFolder('D:\PT168\TELUS_Project_02\ResultFiles')
